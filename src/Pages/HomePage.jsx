...
const data = [
  ...
  {
    image: a4,
    name: "Dr. Ratan Singh Jaggi",
    description:
" Dr. Jaggi has handed out to the mankind a vast and invaluable treasure of more than 129 publications on a variety of subjects, ranging from ancient to the modern periods of Bhakti as well as Punjabi literature.",
  },
  {
    image: a2,
    name: "Prof. Narinder Singh Kapoor",
    description:
      "Sardar Narinder Singh Kapoor  is an Indian writer from Punjab. His writings are about social, cultural and psychological issues. He lives in Patiala, Punjab.He graduated with his M.A. in English from the Punjabi University at Patiala.",
  },
  {
    image: a3,
  ...
  />
      ...
      <div className="grid  grid-cols-2 gap-1">
        <div className="w-full relative">
          <h1 className='text-7xl text-center absolute bg-red-600  mt-40 text-white w-full'>America</h1>
          <img
      ...
      <div className=" flex justify-center">
        ...
        <Link to="/research3">Regional Centres</Link> 
              ...
              <button
                ...
                className=" py-2 px-4 text-sm mx-2 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
   <Link to="/research5">Teaching and Research Department</Link>    
              </button>
              <button
                type="submit"
                className=" py-2 px-4 text-sm mx-2 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
